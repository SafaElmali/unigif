    ...
    <Row type="flex" justify="center">
      <Col xs={24} className="header-props">
        <Row className="header-row-props text-center-row">
          ...
          <Col xs={24}>
            <Text strong className="header-text text-color">
              Make universal search to find funny GIFs, reaction GIFs, unique
              GIFs and more.
            </Text>
          </Col>
          <Col xs={24}>
          ...
          {isSearch ? (
            <Col xs={24}>
              <div className="display-trend-props">
                <button onClick={handleDisplayTrends} className="trend__button">
                  Display Trends
                </button>
              </div>
            </Col>
